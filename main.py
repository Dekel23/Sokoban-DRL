...
def load_level(level_index):
    ...
    pygame.display.set_mode(
        (game_map.map_width, game_map.map_height), pygame.RESIZABLE)
...
while running:
    ...
    if info_to_change:
        for tile_info in info_to_change:
            ...
            new_tile = Tile(game_map.tileTypes[int(
                type)], x * game_map.tile_size, y * game_map.tile_size, game_map.spritesheet)
